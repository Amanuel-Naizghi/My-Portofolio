...
export default function Home(){
    ...
    return(    
       <div className="home-page">
            <Header></Header>
            <div className="flex flex-col items-center justify-center min-h-screen sm:mt-20">
                <div className="flex flex-col md:flex-row rounded-lg overflow-hidden h:50 lg:h-100">
                    ...
                    <div className="w-full md:w-2/3 p-6 flex flex-col">
                        <div>
                            ...
                            <p className="text-gray-600 mt-4 text-center lg:text-2xl text-[17px]">
                        ...
                        <div className="flex space-x-4 mt-12 justify-center">
                            <button className="bg-[#797A7E] text-white px-4 py-2 rounded-full hover:bg-blue-600">Download Resume</button>
